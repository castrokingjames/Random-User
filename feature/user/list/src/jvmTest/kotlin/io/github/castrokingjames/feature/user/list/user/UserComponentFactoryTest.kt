...
class UserComponentFactoryTest {
  ...
  private lateinit var factory: UserComponent.Factory
  ...
  fun setup() {
    ...
    factory = UserComponentFactory(loadUserByUserId, loadAddressByUserId, dispatcher)
  }
  ...
  fun testCreateComponent() {
    ...
    val component = factory(userId, defaultComponentContext, onUserClick = {})
