...
class DetailsComponentTest {
  ...
  fun testUiStateIsLoadingWhenInitialized() {
    runBlocking {
      ...
      assertEquals(DetailsComponent.UserUiState.Loading, component.userUiState.value)
    }
  }
    ...
    runBlocking {
      ...
      component
        ...
        .test {
          ...
          assertTrue(userUiState is DetailsComponent.UserUiState.Success)
  ...
  fun testUiStateIsErrorWhenUserDoesNotExist() {
    runBlocking {
      ...
      component
        ...
        .test {
          val userUiState = awaitItem()
          assertTrue(userUiState is DetailsComponent.UserUiState.Error)
  ...
  fun testOnBackClickThenOnBackClickCalled() {
    runBlocking {
      val userId = "1"
      var isBackClickCalled = false
      val component = createComponent(
        userId,
        onBackClick = {
          isBackClickCalled = true
        },
      )
      component.onBackClick()
      assertTrue(isBackClickCalled)
    }
  }
